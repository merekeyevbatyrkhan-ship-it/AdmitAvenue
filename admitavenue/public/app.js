...
featureAi:'Talk through your questions', featureAiText:'An AI assistant for questions about your choices, preparation and personal plan.', sampleQuestion:'What if I haven’t taken IELTS yet?', sampleReply:'That’s a starting point, not a dead end.<br>Your roadmap can include preparation.', aiPlanned:'AI chat is available ↘',
...
featureAi:'Мазалаған сұрақтарды талқылау', featureAiText:'Таңдау, дайындық және жеке жоспарың туралы сұрақтарға арналған AI-көмекші.', sampleQuestion:'IELTS-ті әлі тапсырмасам ше?', sampleReply:'Бұл кедергі емес, бастау нүктесі.<br>Дайындықты жоспарыңа енгіземіз.', aiPlanned:'AI-чат қолжетімді ↘',
